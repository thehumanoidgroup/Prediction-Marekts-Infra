...
def serialize_account(session: TraderSession, store: TradingStore) -> dict:
    ...
    return {
        ...
        "challengeStatus": progress.status.value,
        ...
        "drawdownMode": limits.drawdown_mode.value,
        "drawdownFloor": round(progress.drawdown_floor, 2),
        "highWaterMark": round(progress.high_water_mark, 2),
